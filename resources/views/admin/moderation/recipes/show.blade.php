    ...
    <div class="container py-4">
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.moderation.recipes.index') }}">Moderation</a></li>
                <li class="breadcrumb-item active" aria-current="page" style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ data_get($proposed, 'title') ?? data_get($revision, 'recipe.title') }}</li>
            </ol>
        </nav>
